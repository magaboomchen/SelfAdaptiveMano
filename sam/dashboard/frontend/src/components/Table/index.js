...
export default {
  ...
  methods: {
     ...
     * @param Boolean bool
     */
    refresh (bool = false, showLoading = true) {
      bool && (this.localPagination = Object.assign({}, {
        current: 1, pageSize: this.pageSize
      }))
      this.loadData(undefined, this.filters, this.sorter, showLoading)
    },
    /**
     * 加载数据方法
     ...
     */
    loadData (pagination, filters = this.filters, sorter = this.sorter, showLoading = true) {
