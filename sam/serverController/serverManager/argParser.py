...
class ArgParser(ArgParserBase):
    def __init__(self, *args, **kwargs):
        ...
        self.parser.add_argument('zoneName', metavar='pcia', type=str, nargs='?', const=1, default='TURBONET_ZONE',
            help="the name of zone, default: ''")
        self.parser.add_argument('-h', '--help', action='help', default=argparse.SUPPRESS,
                            help='Example usage: python serverManager.py MININET_ZONE or python serverManager.py')
