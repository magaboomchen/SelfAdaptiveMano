ControlSocket(tcp, 8888, VERBOSE true)

mon_left :: AggregateIPFlows(TRACEINFO 'mon_left.xml')
mon_right :: AggregateIPFlows(TRACEINFO 'mon_right.xml')
...
ipip_left -> StripIPHeader() -> CheckIPHeader2() -> mon_left;
ipip_right -> StripIPHeader() -> CheckIPHeader2() -> mon_right;

// restore and send out. (TODO: Here Unstrip(34 = 14 ether header + 20 ip header), but ip header may not be 20.)
mon_left[0] -> Unstrip(34) -> out1;
mon_left[1] -> Unstrip(34) -> out1;
mon_right[0] -> Unstrip(34) -> out0;
mon_right[1] -> Unstrip(34) -> out0;