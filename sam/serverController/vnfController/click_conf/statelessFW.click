...
ipip_left -> IPPrint(Left-Outer) -> StripIPHeader() -> CheckIPHeader2() -> IPPrint(Left-Inner) -> fw_left;
ipip_right -> IPPrint(Right-Outer) -> StripIPHeader() -> CheckIPHeader2() -> IPPrint(Right-Inner) -> fw_right;

// restore and send out. (TODO: Here Unstrip(34 = 14 ether header + 20 ip header), but ip header may not be 20.)
fw_left -> IPPrint(Filtered) -> Unstrip(34) -> out1;
fw_right -> IPPrint(Filtered) -> Unstrip(34) -> out0;