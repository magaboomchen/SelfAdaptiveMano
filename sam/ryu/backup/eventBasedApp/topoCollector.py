...
from sam.ryu.ryuCommandAgent import GetTopologyEvent
...
class TopoCollector(BaseApp):
    ...
    _EVENTS = [TopologyChangeEvent,GetTopologyEvent]
    ...
    @set_ev_cls(GetTopologyEvent)
    def _get_topology_event_handler(self, ev):
        cmd = ev.msg
        attr = {
