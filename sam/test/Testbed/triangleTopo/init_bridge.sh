...
ovs-vsctl add-port br1 ge-1/1/32 vlan_mode=trunk tag=2 -- set interface ge-1/1/32 type=pica8

echo "add interface ge-1/1/34"
ovs-vsctl add-port br1 ge-1/1/34 vlan_mode=trunk tag=2 -- set interface ge-1/1/34 type=pica8

echo "add interface ge-1/1/37"
ovs-vsctl add-port br1 ge-1/1/37 vlan_mode=trunk tag=2 -- set interface ge-1/1/37 type=pica8

echo "add interface ge-1/1/39"
ovs-vsctl add-port br1 ge-1/1/39 vlan_mode=trunk tag=2 -- set interface ge-1/1/39 type=pica8

echo "add interface te-1/1/50"
ovs-vsctl add-port br2 te-1/1/50 vlan_mode=trunk tag=3 -- set interface te-1/1/50 type=pica8

echo "add interface ge-1/1/26"
ovs-vsctl add-port br2 ge-1/1/26 vlan_mode=trunk tag=3 -- set interface ge-1/1/26 type=pica8

echo "add interface ge-1/1/36"
ovs-vsctl add-port br2 ge-1/1/36 vlan_mode=trunk tag=3 -- set interface ge-1/1/36 type=pica8
